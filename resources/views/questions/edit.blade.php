                ...
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-12 d-flex no-block align-items-center">
                            <h3 class="page-title">Update Pertanyaan ID : {{ $question->id }}</h3>
                            <div class="ml-auto text-right">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="/home">Home</a></li>
                                        <li class="breadcrumb-item"><a href="/question">List Pertanyaan</a></li>
                                        <li class="breadcrumb-item"><a href="/question/{{ $question->id }}">Details
                                                Pertanyaan</a>
                                        </li>
            ...
            <div class="container-fluid">
                <form action="/question/{{ $question->id }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <small id="emailHelp" class="form-text text-muted">Pastikan judul belum pernah ditanyakan</small>
                    </div>
                    <div class="form-group">
                        ...
                        <textarea name="isi" id="isi" class="form-control my-editor"
                            ...
                            value="{{ old('isi', '') }}">{{ $question->isi }}</textarea>
                        @error('isi')
